...
declare namespace request {
    interface RequestAPI<TRequest extends Request, TOptions extends CoreOptions, TUriUrlOptions> {
        ...
        cookie(str: string): object | undefined;
    ...
    interface Response extends http.IncomingMessage {
        ...
        caseless: object; // case-insensitive access to headers
    ...
    interface CookieJar {
        setCookie(cookieOrStr: object | string, uri: string | Url, options?: object): void;
        getCookieString(uri: string | Url): string;
        getCookies(uri: string | Url): object[];
    }
}
